...
class Category extends CI_Controller {
	...
	public function index()
	{
		...
		$first=$this->phantrang->PageFirst($limit, $current); //đầu trang
		$total=$this->Mcategory->category_count();//trả về giá trị của hàm
	...
	public function insert()
	{
		...
		if($user_role['role']==2){//vai trò người dùng
