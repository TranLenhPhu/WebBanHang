    ...
    <section class="content-header">
        ...
        <div class="breadcrumb">
            ...
            <a class="btn btn-primary btn-sm" href="admin/useradmin/recyclebin" role="button">
                ...
                (<?php $total=$this->Muser->user_trash_count(); echo $total; ?>)
            </a>
        </div>
    </section>
    <!-- Main content -->
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:100px">
                                                    <img src="public/images/admin/<?php echo $row['img'] ?>"
                                                ...
                                                <td class="text-center">
                                                    <a
                                                        href="<?php echo base_url() ?>admin/useradmin/status/<?php echo $row['id'] ?>">
                                                        <?php if($row['status']==1):?>
