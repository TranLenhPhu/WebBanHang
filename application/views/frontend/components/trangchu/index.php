            ...
            <div class="products-sale">
                <div class="lt-product-group-image">
                    <a href="<?php echo $row['alias'] ?>" title="<?php echo $row['name'] ?>">
                        <img style="height: 230px" class="img-p"
                    ...
                    <div class="price-product-item">
                        ...
                        <div class="hidenitem">
                            <a href="<?php echo $row['alias'] ?>">
                                <p class="iconstar"><i class="fas fa-star"></i><i class="fas fa-star"></i><i
                ...
                <ul class="sub-category">
                    ...
                    <li>
                        <a href="san-pham/<?php echo $rowSubCategory['link'] ?>"
                            title="<?php echo $rowSubCategory['name'] ?>" class="ws-nw overflow ellipsis">
            ...
            <div class="list-product-content">
                ...
                <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 product-one">
                    ...
                    <div class="btn-action">
                        <button type="button" class="fa fa-shopping-cart"
                            onclick="onAddCart(<?php echo $sp['id']  ?>)"></button>
...
<section class="home-blog">
    <div class="container">
        <div class="title-line">
            <h2 class="title" style="color: #ff9800; font-size: 25px">Tin tức</h2>
        </div>
        <div class="blog-content">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 margin-bot-6">
                <div class="post-grid clearfix" style="padding-bottom: 30px">
                    <div class="entry-thumb width50 pull-left">
                        <a href="tin-tuc/<?php echo $rowPost['alias'] ?>">

                            <img width="95%" height="200px" src="public/images/posts/<?php echo $rowPost['img'] ?>">
                        </a>
                    </div>
                    <div class="entry-content width50 pull-left padding-10">
                        <div class="entry-meta">
                            <h4><a href="tin-tuc/<?php echo $rowPost['alias'] ?>"><?php echo $rowPost['title'] ?></a>
                            </h4>
